...
```bash
.claude/skills/context-index/scripts/validate-context-frontmatter.sh .context/plans/<plan-file>.md
```
...
1. **Frontmatter validation** -- run `validate-context-frontmatter.sh` on the
   ...
   ```bash
      .claude/skills/context-index/scripts/validate-context-frontmatter.sh <file>
   ```
